...
├─ Participants: 100イベント × 平均4人 = 400レコード/月 × 12月 = 4,800レコード/年
├─ Venues: 100イベント × 平均2会場 = 200レコード/月 × 12月 = 2,400レコード/年
└─ Settlements: 400参加者/月 × 12月 = 4,800レコード/年

月間総レコード数: 1,100レコード
年間総レコード数: 13,200レコード（軽量）
```
